export const ky = {
    ...
    problemStatement: {
        ...
        problems: [
            {
                title: 'Команда жана киреше өсүшү үчүн бир система',
                description: 'Мониторинг, аналитика, сапат контролу, кызматкерлерди окутуу жана сатуу — команданы жана кирешени бир эле учурда өстүргөн бир курал.',
            },
            {
                title: 'EvoPay — мекемелер жана конокторго бирдиктүү платформа',
                description: 'Мекемелерди жана алардын коноктору менен байланыштырган бирдиктүү платформа. Онлайн буйрутмалар, накталай эмес төлөм, QR-меню жана 10% га чейин кешбэк менен лоялдуулук программасы — баары бир жерде.',
            },
            {
                title: 'Клиникада башаламандык — бейтаптар кетет',
                description: 'Телефон аркылуу жазуу, жоголгон карталар, өткөрүлүп жиберилген кабыл алуулар. Дарыгерлер дарылоонун ордуна күнүмдүк ишке убакыт коротот. Бейтаптар атаандаштарга кетет.',
            },
            {
                title: 'Документтер жоголот, макулдашуулар созулат',
                description: 'Кагаз документ жүгүртүү, жоголгон версиялар, бузулган мөөнөттөр. Документ кайсы этапта жана ким жооптуу экенин эч ким билбейт.',
            },
            {
    ...
    solutionsPreview: {
        ...
        subtitle: 'Кардарларды тейлөө, төлөмдөр, саламаттыкты сактоо, иштеп чыгуу жана документ жүгүртүүнү автоматташтыруу үчүн беш продукт',
        ...
        solutions: [
            ...
            {
                title: 'ЭДО',
                description: 'Корпоративдик электрондук документ жүгүртүү платформасы. Толук цикл: түзүү, макулдашуу, аткарууну контролдоо жана аудит, мультитенанттуулук менен.',
                features: ['Ийкемдүү макулдашуу маршруттары', 'Контролёр панели', 'Мультитенанттуулук', 'SSO жана RBAC'],
                metricValue: '5',
                metricLabel: 'системадагы ролдор',
            },
            {
                title: 'CCE Platform',
