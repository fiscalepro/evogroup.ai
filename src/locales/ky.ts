export const ky = {
    header: {
        ...
        evopay: 'EvoPay',
        evoclinic: 'EvoClinic',
        smartuchet: 'Универсалдуу Кабинет',
        cce: 'CCE',
        cases: 'Мисалдар',
    ...
    problemStatement: {
        ...
        problems: [
            {
                title: 'Кардарлар жазат — эч ким жооп бербейт',
                description: 'WhatsApp, Instagram, Telegram\'дагы билдирүүлөр топтолот. Менеджерлер өтүнүчтөрдү өткөрүп жиберет, кеч жооп берет, кайра чалууну унутат. Сатуулар күн сайын жоголот.',
            },
            {
                title: 'Официанттар жетишпейт, чектер өспөйт',
                description: 'Конокторго заказ берүү үчүн күтүшөт. Официант бош эмес. Кошумча сатуу жок, аналитика жок. Орточо чек ордунда турат, тейлөө сапаты түшөт.',
            },
            {
                title: 'Иштеп чыгуу жай жана башаламан',
                description: 'Код-ревью күндөрдү алат. Жалпы стандарттар жок. Билим адамдардын башында калат. Команда өсөт, бирок ылдамдык өспөйт.',
            },
        ],
