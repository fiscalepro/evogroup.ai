export const ky = {
    ...
    hero: {
        ...
        title: 'AI жайгаштырабыз жана бизнестерди автоматташтырабыз',
        titleHighlight: ['кирешелүү өсүш', 'максималдуу натыйжа', 'сиздин максаттар'],
        subtitle: 'Биз сиздин бизнесиңизди текшеребиз, процесстерди тууралайбыз жана AI автоматташтырууларды орнотобуз — тоскоолдуктарды жоюу жана команданын өндүрүмдүүлүгүн жогорулатуу үчүн',
        ctaPrimary: 'Баштоо',
    ...
    trustSignals: {
        overline: 'Жыйынтыктар',
        title: 'Натыйжалар өз алдынча сүйлөйт',
        subtitle: 'Кыргызстандын эң маанилүү тармактарына он жыл ичинде корпоративтик AI чечимдерин жеткирүү',
        industriesLabel: 'Биз кызмат кылган тармактар',
        ...
        clients: [
            { icon: 'bank' as const, name: 'Банктар', description: 'Финансы мекемелери', metric: '20+ банк жана кредиттик союздар' },
            { icon: 'oil' as const, name: 'Мунай-газ', description: 'Өнөр жай сектору', metric: '8 ири компания' },
