        ...
        solutions: [
            {
                ...
                description: 'Online scheduling, patient records, WhatsApp API and AI-bot for appointments',
                metricValue: '−40%',
                metricLabel: 'missed appointments',
            },
            {
                title: 'EvoAI CRM',
                category: 'Team & revenue growth',
                description: 'Monitoring, analytics, AI-bots and training — one management tool',
                metricValue: '+34%',
                metricLabel: 'sales growth',
            },
            {
                title: 'EvoPay',
                category: 'Unified venue platform',
                description: 'QR-menu, online orders, cashless payments and loyalty in one place',
                metricValue: '+30%',
                metricLabel: 'average check',
            },
            {
                title: 'EDO',
                category: 'Electronic document management',
                description: 'Full cycle: creation, approval, control and audit with multi-tenancy',
                metricValue: '−70%',
            ...
            },
            {
                ...
                description: 'Centralized skills, swarm intelligence, ADR process and DORA metrics',
                metricValue: '−80%',
