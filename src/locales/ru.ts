export const ru = {
    ...
    hero: {
        ...
        titleLine1: 'Внедряем AI и автоматизируем бизнесы',
        titleLine2: 'для максимальной эффективности',
    ...
    keyPartners: {
        ...
        cards: {
            finTech: {
                name: 'Fin Tech',
                description: 'Работа с банковскими кошельками — 16 микросервисов',
            },
            energyOS: {
                name: 'Energy OS',
                description: 'АЗС и нефтебазы',
            },
            horeca: {
                name: 'HoreCA',
                description: 'Автоматизация ресторанов и отелей',
            },
            clinicOS: {
                name: 'Clinic OS',
                description: 'Управление клиникой и WhatsApp',
            },
            businessOS: {
                name: 'Business OS',
    ...
    problemStatement: {
        ...
        problems: [
            {
                title: 'Сотрудники работают,\nно результата не видно',
                description:
                    'Непонятно кто продаёт, кто буксует и где теряются клиенты. Управлять командой приходится вслепую.',
            },
            {
                title: 'Заказы, оплата, лояльность — всё\nв разных системах',
                description:
                    'Официант не видит заказ с сайта. Кассир не знает про бонусы гостя. Каждый инструмент живёт отдельно — и гости это чувствуют.',
            },
            {
                title: 'Хаос в клинике —\nпациенты уходят',
                description:
                    'Запись по телефону, потерянные карты, пропущенные приёмы. Врачи тратят время на рутину вместо лечения. Пациенты уходят к конкурентам.',
            },
            {
                title: 'Документы теряются,\nсогласования затягиваются',
                description:
                    'Бумажный документооборот, потерянные версии, сорванные дедлайны. Никто не знает, на каком этапе документ и кто ответственный.',
            },
            {
                title: 'Узкое место — код-ревью',
                description:
                    'Разработчики ждут ревью днями. Знания остаются разрозненными. Стандарты расплываются.',
            },
        ],
    ...
    footer: {
        ...
        solutions: {
            ...
            items: [
                ...
                { label: 'EvoPay', sublabel: 'QR-меню, заказы, онлайн-оплата' },
                { label: 'EvoCabinet', sublabel: 'ЭСФ, ЭТТН, налоговая отчётность и аналитика' },
                { label: 'ЭДО', sublabel: 'Электронный документооборот' },
    ...
    solutionsPreview: {
        ...
        solutions: [
            {
                title: 'EvoClinic',
                category: 'Автоматизация клиники',
                description: 'Онлайн-запись, карты пациентов, WhatsApp API и AI-бот для приёмов',
                metricValue: '−40%',
                metricLabel: 'пропущенных приёмов',
            },
            {
                title: 'EvoAI CRM',
                category: 'Рост команды и прибыли',
                description: 'Мониторинг, аналитика, AI-боты и обучение — один инструмент управления',
                metricValue: '+34%',
                metricLabel: 'рост продаж',
            },
            {
                title: 'EvoPay',
                category: 'Единая платформа заведения',
                description: 'QR-меню, онлайн-заказы, безналичная оплата и лояльность в одном месте',
                metricValue: '+30%',
            ...
            },
            {
                ...
                description: 'Полный цикл: создание, согласование, контроль и аудит с мультитенантностью',
                metricValue: '−70%',
                metricLabel: 'время согласования',
            },
            {
                title: 'CCE Platfarm',
                category: 'AI-инструменты для разработки',
                description: 'Централизованные навыки, роевой интеллект, ADR-процесс и метрики DORA',
                metricValue: '−80%',
                metricLabel: 'время ревью',
            },
        ],
    },
    certifications: {
        ...
        cases: [
            {
                ...
                title: 'Полная система ЭДО автоматизировала документооборот нефтегазовой компании',
                description: 'Компании «Партнёр Нефть» требовалась полноценная система электронного документооборота. Мы разработали бэкенд на Spring Boot 3.2.5 и фронтенд на React 18, JWT-авторизацию, файловое хранилище MinIO, кэширование Redis и PostgreSQL с Flyway.',
                metrics: [
            ...
            },
            {
                ...
                num: '02',
                company: 'BIAST.KG',
                title: 'Полная автоматизация: от входящей заявки до отгрузки',
                description: 'Производитель сэндвич-панелей терял заявки и тратил часы на ручную обработку заказов. Мы внедрили AI-чатбот, CRM и дашборд — всё стало прозрачным.',
                metrics: [
            ...
            },
            {
                ...
                title: 'AI-чатбот заменил 2 менеджеров и поднял продажи на 35%',
                description: 'Магазин сотовых телефонов терял клиентов в Instagram и WhatsApp — медленные ответы, пропущенные запросы в нерабочее время. Внедрили AI-чатбота, который знает весь каталог, подбирает телефоны и принимает заказы 24/7.',
                metrics: [
            ...
            },
            {
                ...
                num: '04',
                company: 'Платформа обучения',
                title: 'ИИ-платформа обучения сократила онбординг с 2 недель до 3 дней',
                description: 'Дистрибьютор тратил недели на ручное обучение торговых представителей. Мы создали ИИ-платформу с курсами по должностям, ИИ-тренером 24/7, автоматическими экзаменами и мгновенными отчётами.',
                metrics: [
    ...
    ctaSection: {
        overline: 'НАЧНИТЕ СЕГОДНЯ',
        titleLine1: 'Готовы запустить',
        titleHighlight: 'AI',
        titleLine2: 'в вашем бизнесе?',
        subtitle: 'Бесплатно разберём вашу ситуацию и запустим пилотный проект за 2 недели — без обязательств.',
        btnPrimary: 'Получить бесплатное демо',
