export const ru = {
    ...
    problemStatement: {
        ...
        problems: [
            ...
            {
                title: 'EvoPay — единая платформа для заведений и гостей',
                description: 'Единая платформа, которая соединяет заведения и их гостей. Онлайн-заказы, оплата без наличных, QR-меню и программа лояльности с кешбэком до 10% — всё в одном месте.',
            },
            {
                title: 'Хаос в клинике — пациенты уходят',
                description: 'Запись по телефону, потерянные карты, пропущенные приёмы. Врачи тратят время на рутину вместо лечения. Пациенты уходят к конкурентам.',
            },
            {
                title: 'Документы теряются, согласования затягиваются',
                description: 'Бумажный документооборот, потерянные версии, сорванные дедлайны. Никто не знает, на каком этапе документ и кто ответственный.',
            },
            {
    ...
    solutionsPreview: {
        title: 'Наши решения',
        subtitle: 'Пять продуктов для автоматизации обслуживания, платежей, здравоохранения, разработки и документооборота',
        learnMore: 'Подробнее',
        ...
        solutions: [
            ...
            {
                title: 'ЭДО',
                description: 'Корпоративная платформа электронного документооборота. Полный цикл: создание, согласование, контроль исполнения и аудит с мультитенантностью.',
                features: ['Гибкие маршруты согласования', 'Дашборд контролёра', 'Мультитенантность', 'SSO и RBAC'],
                metricValue: '5',
                metricLabel: 'ролей в системе',
            },
            {
                title: 'CCE Platform',
