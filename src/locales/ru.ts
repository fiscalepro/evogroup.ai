export const ru = {
    ...
    problemStatement: {
        ...
        problems: [
            {
                title: 'Клиенты пишут — никто не отвечает',
                description: 'Сообщения в WhatsApp, Instagram, Telegram копятся. Менеджеры пропускают заявки, отвечают поздно, забывают перезвонить. Продажи теряются каждый день.',
            },
            {
                title: 'Официанты не успевают, чеки не растут',
                description: 'Гости ждут, чтобы заказать. Официант занят. Нет допродаж, нет аналитики. Средний чек стоит на месте, качество обслуживания падает в час пик.',
            },
            {
                title: 'Разработка медленная и хаотичная',
                description: 'Код-ревью занимает дни. Нет общих стандартов. Знания остаются в головах. Команда растёт, а скорость — нет.',
            },
        ],
