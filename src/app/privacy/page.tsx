...
- Изилдөө жана аналитика`
                    ...
                    {
                        title: '4. Маалыматтарды берүү',
                        content: `Биз сиздин жеке маалыматтарыңызды сатпайбыз. Биз маалыматыңызды төмөнкү учурларда бөлүшө алабыз:
- Кызматтарыбызды көрсөтүүгө жардам берген кызмат көрсөтүүчүлөр менен
- Интеграцияларга уруксат бергениңизде үчүнчү тараптын платформалары менен
- Бириктирүү, сатып алуу же активдерди сатуу учурунда
- Мыйзам талап кылганда же биздин укуктарыбызды коргоо үчүн`
                    },
                    {
                        title: '5. Маалыматтардын коопсуздугу',
                        content: `Биз төмөнкү коопсуздук чараларын колдонобуз:
- Маалыматтарды берүү үчүн TLS 1.3 шифрлөө
- Маалыматтарды сактоо үчүн AES-256 шифрлөө
- Ролдорго негизделген кирүү контролу
- 24/7 коопсуздук мониторинги
- Үзгүлтүксүз аялуулукту баалоо
- Маалыматтарды коргоо боюнча кызматкерлерди окутуу программалары`
                    },
                    {
                        title: '6. Маалыматтарды сактоо',
                        content: `- Каттоо эсебинин маалыматы: аккаунт жабылгандан кийин 30 күн сакталат
- Кардарлардын маалыматтары: активдүү жазылуу мезгилинде жана жокко чыгаргандан кийин 30 күн сакталат
- Шифрленген камдык көчүрмөлөр: 90 күнгө чейин сакталат
- Аналитикалык маалыматтар: анонимдештирилген формада сакталат`
                    },
                    {
...
Укуктарыңызды ишке ашыруу үчүн privacy@evogroup.ai дарегине кайрылыңыз.`
                    ...
                    {
                        title: '8. Үчүнчү тараптын интеграциялары',
                        content: `Meta платформалары (Instagram, Facebook), WhatsApp Business жана башка кабарлашуу кызматтары менен интеграцияларды колдонгондо, алардын тиешелүү шарттары жана купуялык саясаттары да колдонулат. Сиз каалаган убакта аккаунт жөндөөлөрү аркылуу интеграцияларды өчүрө аласыз.`
                    },
                    {
                        title: '9. Cookie файлдары',
                        content: `Биз төмөнкү cookie түрлөрүн колдонобуз:
- Зарыл cookie файлдары (сайттын негизги функционалы үчүн)
- Функционалдык cookie файлдары (сиздин каалооңузду эстеп калуу үчүн)
- Аналитикалык cookie файлдары (сиз биздин Кызматтарды кантип колдоноорунузду түшүнүү үчүн)
- Маркетингдик cookie файлдары (тиешелүү жарнамаларды көрсөтүү үчүн)

Сиз браузериңиздин жөндөөлөрү аркылуу cookie жөндөөлөрүн башкара аласыз.`
                    },
                    {
                        title: '10. Эл аралык маалымат берүү',
                        content: `Сиздин маалыматтарыңыз сиз жашаган өлкөдөн тышкары өлкөлөрдө иштелиши мүмкүн. Биз эл аралык берүүдө маалыматтарыңызды коргоо үчүн стандарттык келишимдик жоболорду жана башка тиешелүү чараларды колдонобуз.`
                    },
                    {
                        title: '11. Балдардын купуялыгы',
                        content: `Биздин Кызматтар жалаң чоң кишилер үчүн арналган. Биз 18 жаштан ылдый адамдардан жеке маалыматтарды атайлап чогултпайбыз.`
                    },
                    {
                        title: '12. Саясатты жаңыртуу',
                        content: `Биз бул Купуялык саясатын мезгил-мезгили менен жаңырта алабыз. Олуттуу өзгөрүүлөр болгон учурда, биз сизге электрондук почта же платформадагы билдирүү аркылуу кеминде 30 күн мурда кабарлайбыз.`
                    },
                    {
