...
function getContent(locale: string) {
    const content = {
        en: {
            ...
            heroTitle1: 'Smart',
            heroTitleHighlight: 'Uchet',
            heroTitle2: '— Personal Cabinet',
            ...
            advantagesSubtitle: 'Why businesses in Kyrgyzstan choose Smart Uchet',
            advantages: [
            ...
            ctaSubtitle: 'Contact us for a demo and connection to Smart Uchet.',
            ctaButton: 'Contact for demo',
        },
        ru: {
            heroBadge: 'Электронный документооборот',
            heroTitle1: 'Smart',
            heroTitleHighlight: 'Учёт',
            heroTitle2: '— Личный Кабинет',
            ...
            advantagesSubtitle: 'Почему бизнес в Кыргызстане выбирает Smart Учёт',
            advantages: [
            ...
            ctaSubtitle: 'Свяжитесь с нами для демо и подключения к Smart Учёт.',
        ...
        ky: {
            ...
            advantagesSubtitle: 'Эмне үчүн Кыргызстандагы бизнес Smart Учётту тандайт',
            advantages: [
            ...
            ctaSubtitle: 'Smart Учёткө демо жана туташуу үчүн биз менен байланышыңыз.',
