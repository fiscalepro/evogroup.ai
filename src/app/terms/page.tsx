...
- 18 жаштан жогору болуңуз`
                    ...
                    {
                        title: '4. Уруксат берилген колдонуу',
                        content: `Сиз биздин Кызматтарды төмөнкүлөр үчүн колдонбоого макулдугуңузду билдиресиз:
- Колдонулуучу мыйзамдарды же ченемдик актыларды бузуу
- Спам, каалабаган билдирүүлөрдү же кордоочу мазмунду жөнөтүү
- Интеллектуалдык менчик укуктарын бузуу
- Зыяндуу программаларды, вирустарды же зыяндуу кодду берүү
- Биздин системаларга уруксатсыз кирүүгө аракет кылуу
- Уруксатсыз автоматташтырылган каражаттарды колдонуу
- Алдамчылык же жасалма аракеттер
- Башка адамдардын купуялык укуктарын бузуу`
                    },
                    {
                        title: '5. Үчүнчү тараптын интеграциялары',
                        content: `Биздин Кызматтар үчүнчү тараптын платформалары менен интеграцияга мүмкүнчүлүк берет:
- Meta платформалары (Instagram, Facebook, WhatsApp)
- Мессенджерлер (Telegram)
- Башка бизнес куралдары жана API

Бул интеграцияларды колдонгондо:
- Ар бир платформанын колдонуу шарттарын сактоого тийишсиз
- Биз үчүнчү тараптын кызматтарынын жеткиликтүүлүгү үчүн жооптуу эмеспиз
- Сиз бизге туташкан платформалардан маалыматтарды колдонууга уруксат бересиз
- Сиз каалаган убакта аккаунт жөндөөлөрү аркылуу интеграцияларды өчүрө аласыз`
                    },
                    {
                        title: '6. Төлөм шарттары',
                        content: `Акы төлөнүүчү Кызматтар үчүн:
- Абоненттик акы ай сайын же жыл сайын алдын ала алынат
- Мыйзам талап кылган учурларды кошпогондо, бардык төлөмдөр кайтарылбайт
- Биз 30 күн мурда кабарлоо менен баалерди өзгөртө алабыз
- Сиз бизге тиешелүү акыларды төлөм ыкмаңыздан алууга уруксат бересиз
- Төлөбөө кызматтын токтотулушуна алып келиши мүмкүн`
                    },
                    {
                        title: '7. Интеллектуалдык менчик',
                        content: `Кызматтар, анын ичинде бардык программалык камсыздоо, мазмун, соода белгилери жана интеллектуалдык менчик EvoGroup же биздин лицензиарларга таандык.

Сиз өзүңүздүн маалыматтарыңызга жана мазмунуңузга менчик укугун сактайсыз. Кызматтарды колдонуу менен сиз бизге Кызматтарды көрсөтүү үчүн маалыматтарыңызды иштетүүгө чектелген лицензия бересиз.`
                    },
                    {
                        title: '8. Маалыматтарды иштетүү',
                        content: `Биз маалыматтарыңызды Купуялык саясатыбызга ылайык иштетебиз. Кызматтарды колдонуу менен сиз төмөнкүлөрдү тааныйсыз:
- Биз Кызматтарды жана AI-моделдерди жакшыртуу үчүн анонимдештирилген маалыматтарды колдоно алабыз
- Кардарлардын маалыматтары коопсуз сакталат жана мыйзамдарга ылайык иштелет
- Сиз кардарларыңыздан зарыл макулдуктарды алууга жооптуусуз`
                    },
                    {
                        title: '9. Кызмат деңгээли жана колдоо',
                        content: `Биз Кызматтарыбыздын жогорку жеткиликтүүлүгүн колдоого аракет кылабыз:
- Максаттуу иштөө убактысы: 99.9% (пландалган тейлөөнү кошпогондо)
- Колдоо support@evogroup.ai аркылуу жеткиликтүү
- Жооп берүү убактысы жазылуу деңгээлине жараша болот
- Пландалган тейлөө мүмкүн болгондо алдын ала кабарланат`
                    },
                    {
                        title: '10. Жоопкерчиликти чектөө',
                        content: `Мыйзам тарабынан уруксат берилген максималдуу деңгээлде:
- Биздин Кызматтар эч кандай кепилдиксиз "болгондой" берилет
- Биз кыйыр, кокустук же кийинки зыяндар үчүн жооптуу эмеспиз
- Биздин жалпы жоопкерчилигибиз мурунку 12 айда сиз төлөгөн акыдан ашпайт`
                    },
                    {
                        title: '11. Зыяндарды компенсациялоо',
                        content: `Сиз EvoGroup, анын кызмат адамдарын, директорлорун, кызматкерлерин жана агенттерин төмөнкүлөрдөн келип чыккан кандай болбосун дооматтардан, зыяндардан же чыгашалардан коргоого жана зыян тартпоого макулсуз:
- Кызматтарды колдонууңуз
- Бул Шарттарды бузууңуз
- Үчүнчү тараптын укуктарын бузууңуз
- Кызматтар аркылуу жөнөткөн мазмунуңуз`
                    },
                    {
                        title: '12. Токтотуу',
                        content: `Тараптардын кайсынысы болбосун бул келишимди токтото алат:
- Сиз каалаган убакта аккаунт жөндөөлөрү аркылуу жазылууңузду жокко чыгара аласыз
- Биз бул Шарттарды бузгандыгыңыз үчүн аккаунтуңузду токтото же бөгөттөй алабыз
- Токтотулгандан кийин Кызматтарга жетүүңүз жабылат
- Токтотулгандан кийин маалыматтарды сактоо Купуялык саясатыбыз менен жөнгө салынат`
                    },
                    {
                        title: '13. Шарттардын өзгөрүшү',
                        content: `Биз бул Шарттарды мезгил-мезгили менен жаңырта алабыз. Олуттуу өзгөрүүлөр жөнүндө алар күчүнө киргенге чейин кеминде 30 күн мурда кабарлайбыз. Өзгөрүүлөрдөн кийин Кызматтарды колдонууну уланткан учурда жаңы Шарттарды кабыл алган болосуз.`
                    },
                    {
                        title: '14. Колдонулуучу мыйзам',
                        content: `Бул Шарттар Кыргыз Республикасынын мыйзамдары менен жөнгө салынат. Бардык талаш-тартыштар Бишкек шаарынын соттору тарабынан чечилет. Эл аралык колдонуучулар үчүн альтернативдүү талаш-тартышты чечүү механизмдерине макулдаша алабыз.`
                    },
                    {
