...
const industryStyles = [
    { accent: 'text-cyan-600 dark:text-cyan-400', dotColor: 'bg-cyan-600 dark:bg-cyan-400' },
    { accent: 'text-amber-600 dark:text-amber-400', dotColor: 'bg-amber-600 dark:bg-amber-400' },
    { accent: 'text-violet-600 dark:text-violet-400', dotColor: 'bg-violet-600 dark:bg-violet-400' },
    { accent: 'text-emerald-600 dark:text-emerald-400', dotColor: 'bg-emerald-600 dark:bg-emerald-400' },
    { accent: 'text-blue-600 dark:text-blue-400', dotColor: 'bg-blue-600 dark:bg-blue-400' },
    { accent: 'text-pink-600 dark:text-pink-400', dotColor: 'bg-pink-600 dark:bg-pink-400' },
]
        ...
        <div className="relative min-h-screen bg-[#eeeeee] dark:bg-[#0A0E1A] transition-colors duration-300">
            ...
            <section className="relative pt-32 pb-16">
                ...
                >
                    ...
                    <p className="text-base lg:text-lg text-gray-600 dark:text-[#F0F0F5]/50 max-w-xl mx-auto leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                        {content.stats.map((s, i) => (
                            ...
                            >
                                ...
                                <div className="text-sm font-medium text-gray-600 dark:text-[#F0F0F5]/55 mb-0.5">{s.label}</div>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.04] mb-5">
                            ...
                            <span className="text-xs text-gray-500 dark:text-white/55 uppercase tracking-widest font-medium">{content.missionBadge}</span>
                        </div>
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white tracking-tight leading-tight mb-4">
                            {content.missionTitle}
                        </h2>
                        <p className="text-base text-gray-600 dark:text-white/50 leading-relaxed max-w-2xl">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                        {content.values.map((v, i) => (
                            ...
                            >
                                <div className="w-10 h-10 rounded-lg border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.04] flex items-center justify-center mb-4 text-gray-500 dark:text-white/60">
                                    {valueIcons[i]}
                                </div>
                                <h3 className="text-base font-bold text-gray-900 dark:text-[#F0F0F5] mb-2">{v.title}</h3>
                                <p className="text-sm text-gray-600 dark:text-[#F0F0F5]/45 leading-relaxed">{v.description}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 border-t border-gray-100 dark:border-[#F0F0F5]/[0.04]">
                <div className="max-w-4xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-10"
                    >
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-[#F0F0F5] tracking-tight mb-3">{content.industriesTitle}</h2>
                        <p className="text-base text-gray-600 dark:text-[#F0F0F5]/45 max-w-lg leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {content.industries.map((ind, i) => (
                            <motion.div
                                key={i} custom={i} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}
                                className="flex items-center gap-3 p-5 rounded-xl border border-gray-200 dark:border-[#F0F0F5]/[0.06] bg-gray-50 dark:bg-[#F0F0F5]/[0.02]"
                            >
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                        {content.techStack.map((cat, i) => (
                            <motion.div
                                key={i} custom={i} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}
                                className="p-7 rounded-2xl border border-gray-200 dark:border-[#F0F0F5]/[0.06] bg-gray-50 dark:bg-[#F0F0F5]/[0.02]"
                            >
                                <span className="text-xs font-medium text-gray-500 dark:text-[#F0F0F5]/35 uppercase tracking-wider mb-4 block">{cat.category}</span>
                                <div className="flex flex-wrap gap-2">
                                    {cat.tools.map((tool, j) => (
                                        <span key={j} className="px-3 py-1.5 rounded-lg border border-gray-200 dark:border-[#F0F0F5]/[0.06] bg-gray-50 dark:bg-[#F0F0F5]/[0.02] text-xs font-medium text-gray-600 dark:text-[#F0F0F5]/60">
                                            {tool}
                                        </span>
                                    ))}
                                </div>
            ...
            <section className="py-24 border-t border-gray-100 dark:border-[#F0F0F5]/[0.04]">
                <div className="max-w-4xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-10"
                    >
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-[#F0F0F5] tracking-tight mb-3">{content.journeyTitle}</h2>
                    </motion.div>
                    ...
                    <div className="flex flex-col gap-4">
                        {content.milestones.map((m, i) => (
                            <motion.div
                                key={i} custom={i} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}
                                className="flex items-start gap-5 p-5 rounded-xl border border-gray-200 dark:border-[#F0F0F5]/[0.06] bg-gray-50 dark:bg-[#F0F0F5]/[0.02]"
                            >
                                <span className="text-2xl font-bold text-gray-400 dark:text-[#F0F0F5]/15 flex-shrink-0 font-mono">{m.year}</span>
                                <p className="text-sm text-gray-600 dark:text-[#F0F0F5]/55 leading-relaxed pt-1">{m.event}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 border-t border-gray-100 dark:border-[#F0F0F5]/[0.04]">
                <div className="max-w-4xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-10"
                    >
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-[#F0F0F5] tracking-tight mb-3">{content.featuresTitle}</h2>
                        <p className="text-base text-gray-600 dark:text-[#F0F0F5]/45 max-w-lg leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {content.features.map((feature, i) => (
                            <motion.div
                                key={i} custom={i} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}
                                className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 dark:border-[#F0F0F5]/[0.06] bg-gray-50 dark:bg-[#F0F0F5]/[0.02]"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-600 dark:text-emerald-400/60 flex-shrink-0">
                                    <polyline points="20 6 9 17 4 12" />
                                </svg>
                                <span className="text-sm text-gray-600 dark:text-[#F0F0F5]/55">{feature}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-[#F0F0F5]/40">{content.ctaSubtitle}</p>
                        </div>
                        <Link
                            href="/contact"
